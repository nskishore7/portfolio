...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "A developer’s real power lies not in knowing all the answers, but in knowing how to solve any problem.",
      photos: ["/gallery/image3.avif"],
    },
    {
      id: 2,
      caption:
        "Code is not just written — it's crafted with logic, creativity, and continuous learning.",
      photos: ["/gallery/image1.jpg"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "Developed a modern E-Learning and Fitness web platform featuring interactive lessons, workout tracking, and a responsive MERN-based design for an engaging user experience.",
      photos: ["/gallery/E-learning.JPG", "/gallery/Fitness.JPG"],
    },
  ],
achievements: [
  {
