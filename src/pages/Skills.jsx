...
const ROWS = [
  [
    { title: "Frontend Development", items: ["React.js", "HTML5", "CSS3", "JavaScript", "Responsive Design"] },
    { title: "Backend Development", items: ["Node.js", "Express.js", "REST APIs", "JWT Authentication"] },
    { title: "Database & Storage", items: ["MongoDB", "Mongoose", "MySQL (Basics)"] },
  ],
  [
    { title: "DevOps & Tools", items: ["Docker", "Jenkins", "AWS (EC2, S3 Basics)", "Git & GitHub", "Postman", "Linux"] },
    { title: "Core Concepts", items: ["Data Structures & Algorithms", "API Integration", "Deployment Automation", "Debugging & Testing"] },
    { title: "Soft Skills", items: ["Problem Solving", "Team Collaboration", "Adaptability", "Time Management"] },
  ],
];
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ⚙️ Technical expertise across full-stack development and DevOps tools — blending backend power with modern UI precision.
        </p>
      </motion.div>
