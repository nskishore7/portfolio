      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ marginTop: 10, fontSize: 15, color: "#ccc" }}>
              BE Graduate | Full Stack Developer – MERN | React.js | Next.js 
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              📍 Indiranagar, Bengaluru, Karnataka
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ nskishore2010@gmail.com | 📞 +91 9994957921
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>Bachelor of Mechanical Engineering</strong> — P.R.C.E.T college, Thanjavur  
              <br />
              <span style={{ color: "#aaa" }}>August 2014 – July 2019</span>
            </li>
          </ul>
        </motion.div>
